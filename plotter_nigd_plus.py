...
for instance in instances:
  xs = [read_column(path("nigd_plus", instance + "_" + solver + ".txt"))
        for solver in solvers]
  raincloud(xs, path("nigd_plus", instance))
...
for solver in solvers:
  ...
  xs.append(x)
raincloud(xs, path("nigd_plus", "nigd_plus"), formats=("png", "pdf"))

report_missing("plotter_nigd_plus.py")
